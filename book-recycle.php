                ...
                <div class="blog-archive-left">
                  ...
                  <article class="blog-news-single">
                    <!-- <div class="blog-news-img">
                      <img src="assets/images/book recycle.png" alt="image">
                    </div> -->
                    <div class="blog-news-title">
                      <a class="purchase-btn" style="color:white;background-color:#a5d01f">Book recycle</a>
                      
                      
                      <!-- <p>By <a class="blog-author" href="#">John Powell</a> <span class="blog-date">|18 October 2015</span></p> -->
                    </div>
                    <div class="blog-news-details blog-single-details">
                      <br><p>The AIFA Reading Society Book Recycle has been established to address the lack of text books in government owned secondary school’s library. Through an annual book drive, the Society will engage private schools, corporate organisations and individuals to support the initiative by donating educational textbooks and other instructional materials.</p>

                      <p>The AIFA Reading Society will in turn distribute these books to select government school libraries with the aim of empowering the students. These better stacked libraries will provide the students with essential reading materials to broaden their minds. Through this project ‘Book Recycle’ the Society seeks to achieve sustainable educational development.</p><br><br>
                      
                      <img src="assets/images/book recycle.jpg" alt="book recycle" height="700px">
