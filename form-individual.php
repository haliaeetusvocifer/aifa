       ...
       <div class="row">
         <div class="col-md-12">
           <div class="title-area">
              <h2 class="title">membership application form</h2>
                 ...
                 <div class="contact-area-right">
                   <form action="" class="comments-form contact-form">
                    <div class="form-group">                        
                      <input type="text" class="form-control" placeholder="Title(Mr, Mrs,...)">
                    </div>
                    <div class="form-group">                        
                    ...
                    <div class="form-group">                        
                      <input type="text" class="form-control" row placeholder="Address">
                    </div>
                    <!-- <div class="form-group">                        
                      <input type="text" class="form-control" placeholder="Institution">
                    </div>
                    <div class="form-group">
                    <input type="checkbox" name="maths" value="on"> Individual Membership
                    <input type="checkbox" name="physics" value="on"> Corporate Membership                        
                    </div> -->
