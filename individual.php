...
<html lang="en">
  <head>
    ...
    <title>AIFA: Membership: Individual</title>
    <!-- Favicon -->
                ...
                <div class="blog-archive-left">
                  ...
                  <article class="blog-news-single">
                    ...
                    <div class="blog-news-details blog-single-details">
                      <p>Membership of AIFA Reading Society is open to anyone committed to the promotion and development of a reading culture and interested in empowering people with an education.</p><br>

                      <h3>Benefits to Potential Members</h3>

                      <p>By becoming a Member of AIFA Reading, you will:</p>
                      ...
                      <ol>
                        ...
                        <li><p>Contribute to helping disadvantage groups gain literacy and cognitive skills</p></li>

                        <li><p>Have the opportunity to mentor disadvantaged young people</p></li>

                        <li><p>Be part of or participate in all or any of the following</p></li>

                          <ul>
                            <p><i class="fa fa-shield fa-rotate-270"></i> Reading Group</p>
                            <p><i class="fa fa-shield fa-rotate-270"></i> Reviewing select books, literatures or journals</p>
                            <p><i class="fa fa-shield fa-rotate-270"></i> Meet with an Author to improve your creativity writing aspiration</p>
                          </ul>

                        <li><p>Meet with interesting people outside of your professional and social circle</p></li>
