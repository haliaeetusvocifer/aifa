...
<html lang="en">
  <head>
    ...
    <title>AIFA: Calculate2succeed</title>
    <!-- Favicon -->
                ...
                <div class="blog-archive-left">
                  ...
                  <article class="blog-news-single">
                    ...
                    <div class="blog-news-title">
                      <a class="purchase-btn" style="color:white;background-color:#a5d01f">Calculate2Succeed</a>
                      
                      <!-- <p>By <a class="blog-author" href="#">John Powell</a> <span class="blog-date">|18 October 2015</span></p> -->
                    </div>
                    <div class="blog-news-details blog-single-details">
                      <br><p>The AIFA Reading Society Calculate2Succeed is one of the projects under the Society’s Junior Initiative. Through this project, the Society seeks to empower students in government owned secondary schools with the tools necessary to succeed in mathematics and science subjects.</p>

                      <p>Over 5000 branded mathematical sets have been distributed to underprivileged children to support them in their education. The Society hopes that these mathematical sets would encourage them to pursue their studies in the field of mathematics or science.</p>

                      <p><a href="contact.php"><b>Contact us</b></a> to get all the information about how to be part of the Calculate2Succeed project.
                      </p><br><br>


                      <img src="assets/images/aifacalculate2suceed.jpg" alt="image" >
