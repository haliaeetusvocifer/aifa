      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="clients-brand-area">
            <ul class="clients-brand-slide slick-initialized slick-slider"><button type="button" data-role="none" class="slick-prev slick-arrow" aria-label="Previous" role="button" aria-disabled="false" style="display: block;">Previous</button>
              <div aria-live="polite" class="slick-list draggable"><div class="slick-track" role="listbox" style="opacity: 1; width: 2280px; height:200px; transform: translate3d(-1140px, 0px, 0px);">
              <li class="col-md-3 slick-slide" data-slick-index="0" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide20" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/KennaPartners.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide21" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/prestigeLogo.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide22" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/funworld.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide23" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/tuenti.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide slick-current slick-active" data-slick-index="4" aria-hidden="false" tabindex="0" role="option" aria-describedby="slick-slide24" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/KennaPartners.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide slick-active" data-slick-index="5" aria-hidden="false" tabindex="0" role="option" aria-describedby="slick-slide25" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/prestigeLogo.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide slick-active" data-slick-index="6" aria-hidden="false" tabindex="0" role="option" aria-describedby="slick-slide26" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/funworld.png" alt="img">
                </div>
              </li><li class="col-md-3 slick-slide slick-active" data-slick-index="7" aria-hidden="false" tabindex="0" role="option" aria-describedby="slick-slide27" style="width: 285px;">
                <div class="single-brand">
                  <img src="assets/images/novarre.png" alt="img">
                </div>
              </li></div></div>
            ...
            <button type="button" data-role="none" class="slick-next slick-arrow slick-disabled" aria-label="Next" role="button" style="display: block;" aria-disabled="true">Next</button></ul>
          </div>
        </div>
      </div>
    </div>
               ...
               <div class="col-md-4">
                 <div class="contact-area-left">
                   ...
                   <address class="single-address">
                     ...
                     <p>info@aifareadingsociety.com</p>
                     <!-- <p>+1(06) 778 5468</p> -->
                   </address> 
